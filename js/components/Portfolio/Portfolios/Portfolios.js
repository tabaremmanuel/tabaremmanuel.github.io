class Portfolios extends React.Component{
    render(){
        return (
            <div id={ this.props.info.name.toLowerCase().replace(/\s/g, '') + '-port' } className="px-0 col-12 col-sm-6 col-md-3 portfolio-item" style={ { backgroundImage: 'url(' + this.props.info.bg + ')' } }>
